 ...
 * @package     Joomla.Platform
 * @subpackage  Form
 * @see         RokCommon_Form_Field_Language for a select list of application languages.
 * @since       11.1
 */
class RokCommon_Form_Field_ContentLanguage extends RokCommon_Form_Field_List
{
	/**
	 * The form field type.
	 *

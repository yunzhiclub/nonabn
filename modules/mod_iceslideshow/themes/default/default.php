...
<div id="iceslideshow<?php echo $module->id; ?>" class="ice-slideshow-default" style="height:<?php echo (int)$params->get('imagemain_height',300);?>px; width:<?php echo (int)$params->get('imagemain_width',650);?>px;">
	...
	<!-- MAIN CONTENT --> 
	<div class="ice-main-wapper" style="height:<?php echo (int)$params->get('imagemain_height',300);?>px; width:<?php echo (int)$params->get('imagemain_width',650);?>px;<?php echo $maincss;?>">

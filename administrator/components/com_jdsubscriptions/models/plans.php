 ...
 */
class JdsubscriptionsModelplans extends JModelList {
    ...
    public function __construct($config = array()) {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'subscription_image', 'a.subscription_image',
                'duration', 'a.duration',
                'unit', 'a.unit',
                'price', 'a.price',
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__jdsubscriptions_plans` AS a');
    ...
    if (is_numeric($published)) {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.name LIKE '.$search.'  OR  a.description LIKE '.$search.'  OR  a.duration LIKE '.$search.'  OR  a.unit LIKE '.$search.' )');
            }
        }

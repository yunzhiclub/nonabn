 ...
 */
class JdsubscriptionsModelorders extends JModelList {
    ...
    /**
     * Build an SQL query to load subscribers name
     *
     * @return	JDatabaseQuery
     * @since	1.6
     */
    public function getSubscriberName($user_id){
        $db = JFactory::getDbo();
        $query = $db->getQuery(true);
        $query->select('name');
        $query->from('#__users');
    ...
    /**
     * Build an SQL query to load the plan name
     *
     * @return	JDatabaseQuery
     * @since	1.6
     */

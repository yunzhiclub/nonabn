 ...
 */
class JdsubscriptionsViewOrders extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JdsubscriptionsHelper::addSubmenu('orders');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JDSUBSCRIPTIONS_TITLE_ORDERS'), 'orders.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_jdsubscriptions&view=orders');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_JDSUBSCRIPTIONS_ORDERS_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_JDSUBSCRIPTIONS_ORDERS_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_JDSUBSCRIPTIONS_ORDERS_CREATED_BY'),
		);
	}
